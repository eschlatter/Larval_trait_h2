...
load("../model_runs/SL_noparent_chains_trim.RData")
SL_noparent_chains <- SL_noparent_chains_trim
...
```{r}
#load 3 model runs (chains) generated in Run_Models.Rmd
load("../model_runs/SL_noparent_expand_chains_trim.RData")
SL_noparent_chains <- SL_noparent_expand_chains_trim
