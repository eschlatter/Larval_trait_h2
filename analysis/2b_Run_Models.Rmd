...
## Test effect of mistrials covariate
#### SL
```{r}
prior = prior1_SL_noparent

no_mistrials <- MCMCglmm(length~1+age,
                   random=~animal+clutch,
                   prior=prior,
                   ginverse=list(animal=Ainv),
                   data=phens,nitt=100000,burnin=1000,thin=10,verbose=TRUE)
with_mistrials <- MCMCglmm(length~1+age+mistrials,
                   random=~animal+clutch,
                   prior=prior,
                   ginverse=list(animal=Ainv),
                   data=phens,nitt=100000,burnin=1000,thin=10,verbose=TRUE)

summary(with_mistrials)
```
...
no_mistrials_Ucrit <- MCMCglmm(speed~1+age,
                   random=~animal+clutch,
                   prior=prior,
                   ginverse=list(animal=Ainv),
                   data=phens,nitt=100000,burnin=1000,thin=10,verbose=TRUE)
with_mistrials_Ucrit <- MCMCglmm(speed~1+age+mistrials,
                   random=~animal+clutch,
                   prior=prior,
                   ginverse=list(animal=Ainv),
                   data=phens,nitt=100000,burnin=1000,thin=10,verbose=TRUE)

summary(with_mistrials_Ucrit)
```
