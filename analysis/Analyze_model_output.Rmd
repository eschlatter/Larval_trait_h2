...
### SL, no parental effects, full data
...
#this one (invgamma2 prior) does the best, but still really not good
```
...
### SL, no parental effects, trimmed data
...
```{r}
load("../model_runs/SL_noparent_chains.RData")
